...
class CalculatorEngineTest {
     ...
     * assertTrue(result.contains("x₁=3") && result.contains("x₂=2") &&
     * result.contains("x₃=1"), "Expected roots 1, 2, 3");
     * }
     * 
     * @Test
     ...
     * result.contains("x₂ = -0.5+0.8660254038i") &&
     * result.contains("x₃ = -0.5-0.8660254038i"),
     * "Expected one real root and two complex");
     * }
     * 
     * @Test
