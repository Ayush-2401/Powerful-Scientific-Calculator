...
class CalculatorEngineTest {
    ...
    void testSolveQuadratic_complexRoots() {
        ...
        assertEquals("x₁ = -0.5+0.866025403784439i, x₂ = -0.5-0.866025403784439i", result);
    }
    ...
    void testSolveCubic_threeRealRoots() {
        ...
        assertEquals("x₁ = 3, x₂ = 1, x₃ = 2", result);
    }
    ...
    void testSolveCubic_oneRealRoot() {
        ...
        assertEquals("x₁ = 1, x₂ = -0.5+0.866025403784439i, x₃ = -0.5-0.866025403784439i", result);
    }
