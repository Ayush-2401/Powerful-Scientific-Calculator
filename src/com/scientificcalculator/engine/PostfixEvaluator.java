...
public class PostfixEvaluator {
    ...
    public double evaluate(List<String> postfixTokens) {
        return evaluate(postfixTokens, null, 0.0);
    }
    ...
    public double evaluate(List<String> postfixTokens, String varName, double varValue) {
        ...
        for (String token : postfixTokens) {
            ...
            } else if (varName != null && token.equalsIgnoreCase(varName)) {
                operandStack.push(varValue);
                System.out.println("PostfixEvaluator Debug:     -> Pushed Variable '" + token + "' as value: " + varValue + ". Current Stack: " + operandStack);
