...
public class InfixToPostfixConverter {
    ...
    public static List<String> convert(List<String> infixTokens) {
        return convert(infixTokens, (List<String>) null);
    }

    public static List<String> convert(List<String> infixTokens, String variableName) {
        return convert(infixTokens, variableName != null ? new ArrayList<>(List.of(variableName)) : null);
    }

    public static List<String> convert(List<String> infixTokens, List<String> variableNames) {
        ...
        for (String initialToken : infixTokens) {
            ...
            } else if (variableNames != null && variableNames.contains(token)) {
