...
public class CalculatorUI extends JFrame implements ActionListener {
    ...
    private void initializeModesMenu() {
        ...
        for (String modeName : modeNames) {
            ...
            if (modeName.equals("Equation Solver")) {
            ...
            } else if (modeName.equals("System of Non-Linear Equations")) {
                menuItem.addActionListener(e -> openNonLinearSystemEquationSolver());
            } else {
    ...
    private void openEquationSolver() {
       UnifiedEquationSolverDialog solverDialog = new UnifiedEquationSolverDialog(this, engine);
    ...
    private void openNonLinearSystemEquationSolver() {
        NonLinearSystemSolverDialog solverDialog = new NonLinearSystemSolverDialog(this, engine);
        solverDialog.setVisible(true);
    }
